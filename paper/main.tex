...
\cref{fig:simulation-rmse} reports the four diagnostics most directly connected to the theory in two representative unlabeled-sample regimes, \(N/n=1\) and \(N/n=16\): absolute bias, empirical Monte Carlo standard deviation, coverage, and relative efficiency versus PPI. Calibration improves efficiency by reducing the residual variance of the score-based estimator, most clearly in the variability and relative-efficiency panels. In the balanced regime \(N/n=1\), AIPW is slightly more efficient than PPI in small samples and comparable in larger samples. In the large-unlabeled regime \(N/n=16\), the two become much closer, and AIPW can be slightly less efficient under substantial misspecification of \(m\). The added benchmarks reinforce the same regime story: PPI++ nearly overlays linear calibration, \textsc{Auto} largely tracks the strongest fixed score-based competitor, and \textsc{MonoSpline} behaves as a smoother monotone alternative to stepwise isotonic calibration. In very small labeled samples the simpler affine corrections remain safest, whereas richer monotone corrections become more attractive once \(n\) is moderately large, especially when unlabeled data are abundant. Coverage remains broadly reasonable throughout, although the more aggressive nonlinear calibration methods mildly undercover at smaller sample sizes.
